...
function EditItem(props) {
  ...
  const updateItem = (e) => {
    setShowLoading(true);
    e.preventDefault();
    const data = {itemCode: item.itemCode, itemName: item.itemName, quantity: item.quantity, supplierCode: item.supplierCode, supplier: item.supplier, contact: item.contact};
